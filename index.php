          ...
          <div class="col-lg-6">
            <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <p class="mb-4 mb-md-5">
               SMK Muhammadiyah 02 Paleran adalah Lembaga pendidikan yang mengedepankan akhlak dan budi pekerti
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
            <div class="image-wrapper">
              <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                <img src="Public/Img/gambar2.jpeg" alt="Business Meeting" class="img-fluid main-image rounded-4">
          ...
          <div class="tab-pane fade active show" id="features-tab-1">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                ...
                <p class="fst-italic">
                  Rekayasa Perangkat Lunak adalah Jurusan yang selalu mengedepankan Logika berpikir dan kreatifitas
                  Seperti : </p>
                <ul>
                  <li><i class="bi bi-check2-all"></i> <span>Menemukan Kesalahan dalam sebuah Aplikasi.</span></li>
                  <li><i class="bi bi-check2-all"></i> <span>Menentukan langkah-langkah yang akan di ambil pada kesemptan selanjutnya.</span></li>
                  <li><i class="bi bi-check2-all"></i> <span>Membuat Aplikasi yang akan berguna untuk memudahkan pekerjaan di masa depan</span></li>
                </ul>
              </div>
