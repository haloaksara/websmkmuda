                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-primary btn-round ms-auto" href="<?= site_url('admin/master/class/add') ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/master/class/list') ?>",
                "type": "POST"
    ...
    $(document).on("click", ".delete", function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    method: "POST",
                    url: "<?php echo base_url('ClassMaster/delete'); ?>",
                    data: "id=" + id,
