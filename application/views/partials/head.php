<head>
  ...
  <style>#call-to-action-2 {
    position: relative;
    background: url('<?= base_url('assets/frontend/img/bagian1.webp') ?>') no-repeat center center fixed;
  ...
  #call-to-action-2::before {
    ...
    width: 100%;
    height: 100%;
    background: rgba(13, 131, 253, 0.8);
    /* Biru gelap dengan transparansi */
    z-index: 1;
  }
